            ...
            if (ModelState.IsValid)
            {
                ...
                if (ea.marketplace == "ED")
                {
                    if (ea.Cat == "Toys")
                    {
                        ...
                        IEnumerable<tbl_Toys> data = ukdb.tbl_Toys.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account1_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                    ...
                    else
                    {
                        if (ea.Cat == "Beauty")
                        {
                            ...
                            DateTime dt = DateTime.Now.AddHours(-24.00);
                            IEnumerable<tbl_Beauty> data = ukdb.tbl_Beauty.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account1_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                            ExportBeauty(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                        }
                        else
                            if (ea.Cat == "SportingGoods")
                            {
                                if (ea.chkresult == true)
                                {
                                ...
                                DateTime dt = DateTime.Now.AddHours(-24.00);
                                IEnumerable<tbl_Sports> data = ukdb.tbl_Sports.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account1_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                ...
                                if (ea.Cat == "Baby")
                                {
                                    ...
                                    DateTime dt = DateTime.Now.AddHours(-24.00);
                                    IEnumerable<tbl_Baby> data = ukdb.tbl_Baby.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account1_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                    ...
                                    if (ea.Cat == "Watches")
                                    {
                                        ...
                                        DateTime dt = DateTime.Now.AddHours(-24.00);
                                        IEnumerable<tbl_Watches> data = ukdb.tbl_Watches.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account1_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                        ...
                                        if (ea.Cat == "Jewelry")
                                        {
                                            ...
                                            DateTime dt = DateTime.Now.AddHours(-24.00);
                                            IEnumerable<tbl_Jewellery> data = ukdb.tbl_Jewellery.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account1_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                ...
                else
                {
                    if (ea.marketplace == "EM")
                    {
                        if (ea.Cat == "SportingGoods")
                        {
                            ...
                            DateTime dt = DateTime.Now.AddHours(-24.00);
                            IEnumerable<tbl_Sports> data = ukdb.tbl_Sports.Where(x => x.UPC != "null" && x.Account2_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                        ...
                        else
                        {
                            if (ea.Cat == "Beauty")
                            {
                                ...
                                DateTime dt = DateTime.Now.AddHours(-24.00);
                                IEnumerable<tbl_Beauty> data = ukdb.tbl_Beauty.Where(x => x.UPC != "null" && x.Account2_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                ExportBeauty(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                            }
                            else
                                if (ea.Cat == "Toys")
                                {
                                    ...
                                    DateTime dt = DateTime.Now.AddHours(-24.00);
                                    IEnumerable<tbl_Toys> data = ukdb.tbl_Toys.Where(x => x.UPC != "null" && x.Account2_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                    ...
                                    if (ea.Cat == "Baby")
                                    {
                                        ...
                                        DateTime dt = DateTime.Now.AddHours(-24.00);
                                        IEnumerable<tbl_Baby> data = ukdb.tbl_Baby.Where(x => x.UPC != "null" && x.Account2_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                        ExportBaby(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                    }
                                    else
                                        if (ea.Cat == "Watches")
                                        {
                                            ...
                                            DateTime dt = DateTime.Now.AddHours(-24.00);
                                            IEnumerable<tbl_Watches> data = ukdb.tbl_Watches.Where(x => x.UPC != "null" && x.Account2_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                            ExportWatches(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                        }
                                        else
                                            if (ea.Cat == "Jewelry")
                                            {
                                                ...
                                                DateTime dt = DateTime.Now.AddHours(-24.00);
                                                IEnumerable<tbl_Jewellery> data = ukdb.tbl_Jewellery.Where(x => x.UPC != "null" && x.Account2_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                                ExportJewelry(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                            }
                        }
                        ...
                        if (ea.marketplace == "DC")
                        {
                            if (ea.Cat == "SportingGoods")
                            {
                                ...
                                DateTime dt = DateTime.Now.AddHours(-24.00);
                                IEnumerable<tbl_Sports> data = ukdb.tbl_Sports.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account3_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.CanadaProhibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                            ...
                            else
                            {
                                if (ea.Cat == "Beauty")
                                {
                                    ...
                                    DateTime dt = DateTime.Now.AddHours(-24.00);
                                    IEnumerable<tbl_Beauty> data = ukdb.tbl_Beauty.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account3_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.CanadaProhibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                    ...
                                    if (ea.Cat == "Toys")
                                    {
                                        ...
                                        DateTime dt = DateTime.Now.AddHours(-24.00);
                                        IEnumerable<tbl_Toys> data = ukdb.tbl_Toys.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account3_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.CanadaProhibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                        ...
                                        if (ea.Cat == "Baby")
                                        {
                                            ...
                                            DateTime dt = DateTime.Now.AddHours(-24.00);
                                            IEnumerable<tbl_Baby> data = ukdb.tbl_Baby.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account3_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.CanadaProhibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                            ...
                                            if (ea.Cat == "Watches")
                                            {
                                                ...
                                                DateTime dt = DateTime.Now.AddHours(-24.00);
                                                IEnumerable<tbl_Watches> data = ukdb.tbl_Watches.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account3_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.CanadaProhibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                                ...
                                                if (ea.Cat == "Jewelry")
                                                {
                                                    ...
                                                    DateTime dt = DateTime.Now.AddHours(-24.00);
                                                    IEnumerable<tbl_Jewellery> data = ukdb.tbl_Jewellery.Where(x => x.UPC != "null" && x.TimeStamp < dt && x.Account3_Status != 1 && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.CanadaProhibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                            ...
                            if (ea.marketplace == "DI")
                            {
                                if (ea.Cat == "SportingGoods")
                                {
                                    ...
                                    DateTime dt = DateTime.Now.AddHours(-24.00);
                                    IEnumerable<tbl_Sports> data = ukdb.tbl_Sports.Where(x => x.UPC != "null" && x.Account4_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                ...
                                else
                                {
                                    if (ea.Cat == "Beauty")
                                    {
                                        ...
                                        DateTime dt = DateTime.Now.AddHours(-24.00);
                                        IEnumerable<tbl_Beauty> data = ukdb.tbl_Beauty.Where(x => x.UPC != "null" && x.Account4_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                        ExportBeauty(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                    }
                                    else
                                        if (ea.Cat == "Toys")
                                        {
                                            ...
                                            DateTime dt = DateTime.Now.AddHours(-24.00);
                                            IEnumerable<tbl_Toys> data = ukdb.tbl_Toys.Where(x => x.UPC != "null" && x.Account4_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                            //IEnumerable<tbl_Toys> data = ukdb.tbl_Toys.Where(x => x.UPC != "null" && (x.Account2_Status == 1 || x.Account2_Status == null) && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                            ExportToys(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                        }
                                        else
                                            if (ea.Cat == "Baby")
                                            {
                                                ...
                                                DateTime dt = DateTime.Now.AddHours(-24.00);
                                                IEnumerable<tbl_Baby> data = ukdb.tbl_Baby.Where(x => x.UPC != "null" && x.Account4_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                                ExportBaby(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                            }
                                            else
                                                if (ea.Cat == "Watches")
                                                {
                                                    ...
                                                    DateTime dt = DateTime.Now.AddHours(-24.00);
                                                    IEnumerable<tbl_Watches> data = ukdb.tbl_Watches.Where(x => x.UPC != "null" && x.Account4_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                                    ExportWatches(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                                }
                                                else
                                                    if (ea.Cat == "Jewelry")
                                                    {
                                                        ...
                                                        DateTime dt = DateTime.Now.AddHours(-24.00);
                                                        IEnumerable<tbl_Jewellery> data = ukdb.tbl_Jewellery.Where(x => x.UPC != "null" && x.Account4_Status != 1 && x.TimeStamp < dt && x.Prime == "1" && x.SalesPrice != "Too low to display" && x.WeightUnits < 501 && x.UK_Prohibited != 1 && x.HeightUnits < 3000 && x.WidthUnits < 3000 && x.LengthUnits < 3000).Take(int.Parse(ea.rownumber.ToString())).ToList();
                                                        ExportJewelry(ea.rownumber, ea.PriceValue, ea.marketplace, data);
                                                    }
                                }
