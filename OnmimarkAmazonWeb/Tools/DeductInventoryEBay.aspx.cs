...
{
    public partial class DeductInventoryEBay : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Library.SynceBayItems(db, Log);
            Library.SynceBayOrders(db, Log);
            Library.MoveInventoryFromCompletedeBayOrders(db, Log);
