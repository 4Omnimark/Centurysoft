...
namespace OmnimarkAmazon.Models
{
    ...
    public partial class ASINOfferScrape
    {
        ...
        public Nullable<int> ActualPages { get; set; }
        public Nullable<int> RecordsPerPage { get; set; }
        public Nullable<int> PagesScraped { get; set; }
        public Nullable<int> ActualOffers { get; set; }
